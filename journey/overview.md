...
A Command Broker is commissioned through an ordered sequence of **six gates**. Each has entry criteria, defined activities, and an exit condition tied to a specific evidence artifact and a single accountable sign-off. The sequence is drawn from the **CB-CT Commissioning &amp; Joint Training** module, which supplies the vendor–AOO handoff the rest of the corpus left implicit.

> **No product operates above the Bright Line at a facility until the Operational Qualification gate has closed for the brokers assigned to it — and re-closes after any material change.**
...
| [5 · Model-Update Re-Qualification](5-model-update-requalification.md) | Re-qualification record + audit continuity | AOO |
| [6 · Periodic Drill](6-periodic-drill.md) | Degraded-mode exercise findings | AOO |
